...
//        org.omg.CORBA.Object test;
      ...
      // true object reference.
       BookSearch remoteObjRef = BookSearchHelper.narrow(genericObjRef);
      
      BookHolder holder = new BookHolder();
      holder.value = new Book();
	  
      remoteObjRef.searchByRef(holder);
      System.out.println(holder.value);
      System.out.println("Author: " + holder.value.title
      +"\nRelease: " + holder.value.author 
      +"\nTitle: "+holder.value.release
      +"\nID: "+holder.value.id);
